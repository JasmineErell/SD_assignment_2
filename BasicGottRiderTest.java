...
public class BasicGottRiderTest {
    ...
    @Test
    public void testsYuval () {
        GottRider a = new GottRider("Alice", 2L, 4.5);
        GottRider b = new GottRider("Bob", 3L, 3.7);

        System.out.println(a.compareTo(b)); // should be > 0
        a.rideCompleted(5L);
        System.out.println(a.getAverageReviewGiven()); // should increase
